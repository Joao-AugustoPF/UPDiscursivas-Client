...
export default function Questões({ session, provas }) {
              ...
              return (
                <div key={index}>
                  ...
                  name.attributes.disciplina
                    .toLowerCase()
                    .includes(inputDisciplina.toLowerCase()) &&
                  name.attributes.cargo
                    .toLowerCase()
                    .includes(inputCargo.toLowerCase()) ? (
                    <>
                      <div className="card bg-light m-auto mb-4 w-50">
                        <div className="card-header d-flex justify-content-between">
                          {name.attributes.title}
                          <div className="d-flex justify-content-end">
                            <p>
                              Ano: <strong>{name.attributes.ano}</strong>
                            </p>
                          </div>
                        </div>
                        ...
                        <div className="card-body">
                          <div className="d-flex">
                            <p className="card-text">
                              <strong>Banca:</strong> {name.attributes.banca}
                            </p>
                            <p className="card-text ms-4">
                              <strong>Cargo:</strong>{" "}
                              {name.attributes.cargo.replace(/_/g, " ")}
                            </p>
                          </div>
                          <div className="d-flex">
                            <p className="card-text">
                              <strong>Disciplina:</strong>{" "}
                              {name.attributes.disciplina.replace(/_/g, " ")}
                            </p>
                            <p className="card-text ms-4">
                              <strong>Orgão:</strong>{" "}
                              {name.attributes.orgao.replace(/_/g, " ")}
                            </p>
                          </div>
                        </div>
                        <div className="d-flex justify-content-center">
                          <Link href={`/questoes/${name.attributes.slug}`}>
                            <a className="btn btn-danger mt-3 mb-3">Corrigir</a>
                          </Link>
                        </div>
                      </div>
                    </>
