...
export default function Questão(props) {
  ...
  //Gets the length of the "questions" inside the "Questions"
  const contador = provas?.perguntas?.attributes?.Pergunta?.length;

  //Creates a list with null values ​​with the amount of questions that have in the Questions
          ...
          <>
            ...
            {provas?.perguntas?.attributes?.Pergunta ? (
              ...
              <div className="mb-4">
                ...
                >
                  <h5 className="card-title">Não há questões com essa URL</h5>
                </div>
              </div>
            )}
